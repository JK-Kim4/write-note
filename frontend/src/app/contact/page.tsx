 ...
 * electron 전용 호출 교체: contact.send(web 메타) / shell.openExternal → window.open(카카오 새 탭).
 */
                        ...
                        <section className="newproject contact" aria-label="문의 보내기">
                            ...
                            <div className="contact-alt">
                                ...
                                <button
                                    ...
                                    onClick={() => webElectronApi.shell.openExternal(KAKAO_CHAT_URL)}
                                >
