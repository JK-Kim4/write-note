/**
 * 아웃라인 파생 (017 US1) — 본문 ProseMirror JSON 에서 level 1·2 heading 목차를 파생한다.
 *
...
export type OutlineItem = {
    ...
    text: string;
    /** 방출 순번 = doc 내 level 1·2 heading 등장 순번. 점프 시 pos 해결 키. */
    index: number;
};
...
/**
 * ProseMirror JSON 문자열에서 level 1·2 heading 을 등장 순서대로 추출한다.
