...
export function WithdrawSection() {
    ...
    return (
        <section className="rounded-xl border border-red-200 bg-surface p-5">
            ...
            <p className="mt-0.5 text-xs text-faint">탈퇴하면 모든 작품·메모·설정이 영구 삭제되며 되돌릴 수 없습니다.</p>
            <button
                type="button"
            ...
            {withdrawOpen ? (
                ...
                >
                    <div className="mx-4 flex w-full max-w-md flex-col gap-4 rounded-xl border border-border bg-surface p-6">
                        <h3 className="text-lg font-semibold text-red-600">정말 탈퇴하시겠어요?</h3>
                        <p className="text-sm text-muted-strong" style={{ lineHeight: 1.6 }}>
                        ...
                        <input
                            ...
                            className="rounded-md border border-border-strong px-3 py-2 text-sm outline-none focus:border-red-400"
                        />
                        {withdrawError ? (
