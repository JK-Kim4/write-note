...
| 0.5 | `00-5-desktop-design-definition/` | 구현 전 desktop MVP 디자인 기준 확정 | 🟡 진행 중 (집필실 확정, 3화면 대기) |
| 1 | `01-desktop-scaffold/` | Electron/Vite desktop app 최소 실행 환경 구축 | 🟡 일부 (렌더러 `desktop/` 프로토타입, 패키징 대기) |
