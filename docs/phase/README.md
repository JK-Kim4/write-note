...
| 0.5 | `00-5-desktop-design-definition/` | 구현 전 desktop MVP 디자인 기준 확정 | 🟡 거의 완료 (4화면+Quick Capture+A4·줌·페이지뷰 확정, 승인 대기) |
| 1 | `01-desktop-scaffold/` | Electron/Vite desktop app 최소 실행 환경 구축 | 🟡 일부 (렌더러 `desktop/` 4화면 라우팅, 패키징 대기) |
