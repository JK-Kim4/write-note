...
배포 = **BE 선행 → FE 후행**. **046/047(V27~V29)·048(V30)은 이미 운영 배포됨**(main, prod Flyway V30 — 2026-07-01 검증). develop은 049(마이그레이션 0)만 앞섬 → 050 배포 시 **신규 마이그레이션 = V31·V32만** 운영 첫 적용. 단 046/047는 authed dogfooding 미수행(ISSUE-053)이라 050 로컬 풀스택이 share 스택의 첫 authed 검증(§15 — 046/047 코어 흐름도 함께 확인).
